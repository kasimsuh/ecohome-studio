...
- model3D.facadeMaterial (optional) — pick from: timber-board, brick, rendered-plaster, stone-veneer, metal-panel, fiber-cement. Match to wallMaterial and architecturalStyle. Timber suits cabin/craftsman/contemporary wood homes; brick suits traditional/colonial; rendered-plaster suits Mediterranean/modern; stone-veneer suits rustic/alpine; metal-panel suits industrial/modern; fiber-cement suits coastal/modern farmhouse.
- model3D.roofMaterial (optional) — pick from: metal-standing-seam, clay-tile, asphalt-shingle, rubber-membrane. Match to roofType and climate. Metal-standing-seam pairs with shed/gable in cold/modern; clay-tile with hip in hot-arid/Mediterranean; asphalt-shingle with gable in cold/temperate; rubber-membrane with flat only.
- model3D.chimneyCount (optional) — integer 0, 1, or 2. Use 1-2 for cold climates and traditional/craftsman/colonial styles with gable or hip roofs. Use 0 for modern flat/shed roofs and hot climates.
- model3D.hasDeck (optional) — boolean. Set true for multi-floor homes (floors >= 2) in temperate or tropical climates that emphasise outdoor living.
- model3D.roofDesign (optional) — eave style: "craftsman" (exposed rafter tails, wide fascia, suits traditional/family/craftsman homes), "contemporary" (thin fascia, clean lines, suits modern/minimal homes), "traditional" (dental molding, medium fascia, suits classic/colonial homes). Omit and the renderer picks randomly.
- model3D.dormerCount (optional) — 0, 1, 2, or 3 dormers on the south slope of a gable roof. Only set for gable roof types. Traditional/craftsman/family/passive homes: 1–2. Modern/flat-roof/shed homes: 0. Omit and the renderer seeded-randomly picks 0–2.
- model3D.bodyStyle (optional) — pick from: box, l-shape, split-level. "box": simple rectangle, all floors same footprint — suits minimal/modern/small homes. "l-shape": main block + single-story wing on east or west at the back, forming an L plan — suits craftsman/traditional/family homes with garages or utility rooms. "split-level": a projecting full-height accent volume on the south facade offset to one side — suits bold contemporary or urban homes. If omitted, the renderer picks randomly using the project seed.
